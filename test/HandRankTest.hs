...
isStraightTests =
  ...
  [
    ...
    TestLabel "hand is a not straight when it has ranks of 2 3 4 5 5" (TestCase (assertBool "hand should not be a straight" (not(isStraight(makeHand(Card Two Spade, Card Three Diamond, Card Four Heart, Card Five Club, Card Five Spade)))))),
