...
/* package poker-with-haskell-0.1.0.0 */
#ifndef VERSION_poker_with_haskell
#define VERSION_poker_with_haskell "0.1.0.0"
#endif /* VERSION_poker_with_haskell */
#ifndef MIN_VERSION_poker_with_haskell
#define MIN_VERSION_poker_with_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_poker_with_haskell */
...
#define CURRENT_PACKAGE_KEY "poker-with-haskell-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "poker-with-haskell-0.1.0.0-inplace"
